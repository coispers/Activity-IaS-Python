...
SCRIPTS_IN_ORDER = [
    "login_role_test.py",
    "manager_salary_access_test.py",
    "staff_salary_denied_test.py",
    "staff_meeting_access_test.py",
    "missing_user_denied_test.py",
]
...
def main() -> None:
    print("Part 3 RBAC sequential runner started.")
